...
Date: 2023-07-11 11:42:52
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for fd_t_minutevalue
-- ----------------------------
DROP TABLE IF EXISTS `fd_t_minutevalue`;
CREATE TABLE `fd_t_minutevalue` (
  `MV_ID` int NOT NULL AUTO_INCREMENT,
  `MV_Stat_Code` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '设备编号',
...
) ENGINE=InnoDB AUTO_INCREMENT=27529 DEFAULT CHARSET=utf8mb3;
